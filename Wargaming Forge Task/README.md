...
## [**Решение алгоритмического задания конкурса Wargaming Forge**](https://github.com/mxmaslin/test-tasks/blob/master/Wargaming%20Forge%20Task/Username_task_1_solution.py)
