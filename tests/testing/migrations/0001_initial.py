    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(0, 'Автор'), (1, 'Респондент')], default=1)),
        ...
        migrations.AddField(
            model_name='user',
            name='question_set',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='testing.QuestionSet'),
        ),
        migrations.AddField(
            model_name='user',
