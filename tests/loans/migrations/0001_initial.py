# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-11-10 18:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('submitted', models.DateField(blank=True, null=True, verbose_name='Дата отправки')),
                ('status', models.PositiveSmallIntegerField(choices=[(0, 'New'), (1, 'Sent')], default=0, verbose_name='Статус заявки')),
